...
public class Shutter {
    ...
    private GameState.state nextScreen;

    Game main;

    public Shutter(Game main) {
        this.main = main;
        nextScreen = null;
    }
    ...
    public void update() {
        if (changingScreen) {
            ...
            if (progress >= 0.48 && progress <= 0.52 && nextScreen != null) {
                main.setState(nextScreen);
                nextScreen = null;
            }
        }
    }

    public void changScreen(GameState.state gss) {
        if (!b) {
            main.setState(gss);
            return;
        }
    ...
    public void render(Graphics g) {
        ...
        g2d.setColor(new Color(5,80,125));
